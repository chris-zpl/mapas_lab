...
if($sala_get){
    ...
    $logs = $cms->getSalas()->getLogs($sala_get);
            ...
            <table class="table" id="logsTable">
                <thead class="table-medium align-middle text-center">
                    <tr>
                        ...
                        <th class="col-md-1" scope="col">Modelo Máquina</th>
                        <th class="col-md-1" scope="col">Máquina</th>
                        <th class="col-md-1" scope="col">Modelo Monitor</th>
                        <th class="col-md-1" scope="col">Monitor</th>
                        <th class="col-md-1" scope="col">Mostrar</th>
